describe '#caesar_cipher' do
  ...
  it 'should return Ndssd Chwd Fkl.' do
    expect(caesar_cipher('Kappa Zeta Chi.', 3)).to eq('Ndssd Chwd Fkl.')
  end
  it "should return Please enter a valid String (e.g. 'Sample text.') and Fixnum (e.g. 5)." do
    expect(caesar_cipher(0, 3)).to eq("Please enter a valid String (e.g. 'Sample text.') and Fixnum (e.g. 5).")
  end
end

describe '#stock_picker' do
  it 'should return the best day to buy and the best day to sell' do
  ...
  context 'when the prices are all the same' do
    it "should return 'The prices are the same each day!'" do
      expect(stock_picker([4, 4, 4, 4])).to eq 'The prices are the same each day!'
    end
  end
  context 'with erroneous input' do
    it "should return 'Please enter a valid array of prices (e.g. [1, 4, 2, 27]).'" do
  ...
  context 'when profit is not possible' do
    it "should return 'Sorry. There's no profit to be had here.'" do
...
describe '#bubble_sort' do
  ...
  context 'when given a block' do
    it 'should sort an array of strings by specifications of the block' do
